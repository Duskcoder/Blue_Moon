...
import Menu from "@mui/material/Menu";
import MenuItem from "@mui/material/MenuItem";
import DetailsHomeStay from "./DetailsHomeStay";
const drawerWidth = 240;
    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <List>
          ...
          <ListItem disablePadding>
            <ListItemButton className="bg-warning" onClick={handleRoomToggle}>
              <ListItemIcon>
                <h4 className="dashboard-h4">
                  <b className="text-white">Rooms</b>
                </h4>
            ...
            <Collapse in={roomOpen} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                <ListItemButton onClick={() => navigate("/room1")}>
                  <ListItemText primary="Room 1" />
                </ListItemButton>
                <ListItemButton onClick={() => navigate("/room2")}>
