            ...
            <div className="container mt-4 mb-5">
                ...
                <div className="row mt-4">
                    ...
                    <div className="col-sm-12 col-lg-3 mb-3 mb-sm-0">
                        <div className="card card-amen">
                            <div className='card-image'>
                                <img className='image-responsive' src={require('../images/butha.jpg')} alt="" width='100%' height='230px' />
                            </div>
                            <div className="card-body text-center">
            ...
            <div className="container mt-4 mb-5">
                ...
                <div className="row mt-4" style={{ color: '#117CA1' }}>
                    ...
                    <div className="col-sm-12 col-lg-3 mb-3 mb-sm-0">
                        <div className="card card-amen">
                            <div className='card-image'>
                                <img className='img-butha' src={require('../images/side.jpg')} alt="" width='100%' height='230px' />
                            </div>
                            <div className="card-body text-center">
                                <h4>Parking Area</h4>
