                        ...
                        <div className='row fruit d-flex justify-content-evenly shadow-lg p-3 mb-5 bg-body rounded'>
                            <div className='col-lg-3 col-md-6 seed mt-3 text-center'>
                                <FloatingLabel controlId="floatingSelect" label="Check -in Date">
                                    <input type="date" className="form-control" id="meeting-date" name="check_in" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.check_in}  min={getTodayDate()}/>
                            ...
                            <div className='col-lg-3 col-md-6 seed  mt-3'>
                                <FloatingLabel controlId="floatingSelect" label="Check -out Date">
                                    <input type="date" className="form-control" id="meeting-date" name="check_out" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.check_out} min={getTodayDate()}/>
