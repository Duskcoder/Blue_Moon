    ...
    <>
      ...
      <div id="aboutUs1" className="overflow-hidden">
        <div className="container pt-5">
          <div className="row ">
            <div
              className="card  hello2  mt-5 col-lg-6 col-12"
              data-aos="fade-right"
            ...
            >
              <div className="card-body">
                ...
                >
                  ...
                  <p className="text-dark">text-dark sure to walk home with memories and wonderful </p>
            ...
            <div
              className="card hello1  col-lg-6 col-12 "
              data-aos="fade-left"
              data-aos-duration="1500"
            >
              <div
                ...
                data-aos-duration="1000"
              >
                <p className="card-text1 mt-5 text-white">
