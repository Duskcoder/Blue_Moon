      ...
      <div className=' container stay mt-5'>
        ...
        <img className='img-responsive invisible   ' src={require('../../images/rooma.jpg')} alt='' width='100%' />
          ...
          <div className='col-6 col-lg-6 jupiter  '  data-aos="fade-up" >
            ...
            <p className='ptag'>Adults:<span className='text-secondary'> 2</span></p>
     ...
     <div className=' container stay '>
       ...
       <img className='img-responsive invisible imgs  ' src={require('../../images/rooma.jpg')} alt='' width='100%' />
         ...
         <div className='col-6 col-lg-6 saturn  'data-aos="fade-up" >
           ...
           <div className='dataMob'>
            <p className='ptag'>Beds: 2 Queen(s)  BedRoom: 2 Hall: 1 Adults:<span className='text-secondary'> 4</span> Dining Space: 1</p>
...
<table className='dataSys'  >
  ...
  <tr>
    <td>       
         <p className=''> Beds: 2 Queen(s)</p> </td>
    <td>  <p className='mx-5'> BedRoom: 2</p></td>
    <td> <p>Hall: 1</p></td>
  </tr>
  <tr>
    ...
    <td> <p className='mx-5'>Dining Space: 1</p></td>
     ...
     <div className=' container stay '>
       ...
       <div className='row'>
       <h3 className='htag fw-bold '>Double BedRoom Apartment First Floor</h3>
