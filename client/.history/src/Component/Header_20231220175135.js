...
function Header() {
  ...
  return (
    <>
        ...
        <div className="header" >
          <div className="d-flex justify-content-center m-auto p-0">
            ...
            <div className="list m-auto p-0">
              <div className="unoderlist  d-flex align-items-center  ">
      ...
      <div className=" header2 " style={{backgroundColor:"#00000057", width: "100%",position:'absolute'}}>
        <div className="d-flex justify-content-between p-2">
          ...
          <div className="toggle mt-4">
            <button
              ...
              style={{ borderRadius: "20px", outline: "none" ,position:'absolute',overflow:'hidden'}}
        ...
        <div className="list">
          <ul
            ...
            style={{backgroundColor:"#00000057", width: "100%"}}
          >
            <li className="num">
              <a href="/">Home</a>
            </li>
