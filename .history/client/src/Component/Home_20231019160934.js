  ...
  return (
    <div >
      ...
      <div className='container mt-5'>
            <h2 className='trun mb-5 text-center text-info'><b>Blue moon bungalow gallery </b></h2>
            <div className='row '>
                <div className='rooter col-12 col-lg-6  text-end mt-2'>
                    <img className='img-responsive' src={require('../images/room.jpg')} alt='' width="70%" height="60%"/>
                </div>
                <div className='rooters col-12 col-lg-6 mt-5 mt-md-2'>
                    <img className='img-responsive' src={require('../images/carner.jpg')} alt='' width="70%" height="60%"/>
                </div>
            </div>
        </div>
