            ...
            <div id='aboutUs'>
                <div className='container '>
                    <div className='row d-flex justify-content-center'>
                        <div class="card first-card col-lg-6" style={{overflowX:"hidden"}}  data-aos='fade-right'  data-aos-duration='1500'>
                            <div class="card-body">
                                <div className='hello22 mt-5'  style={{overflowX:"hidden"}} data-aos='fade-right'  data-aos-duration='1000'></div>
                                <h2 class="card-title text-center mt-5"  data-aos='fade-right'  data-aos-duration='500' style={{color:'#2a919d' , overflowX:"hidden"}}> About Us</h2>
                                ...
                                <div  className='hello22 mt-5 mb-5'  data-aos='fade-right' style={{overflowX:"hidden"}}  data-aos-duration='1000'></div>


                            </div>
                        </div>

                        <div class="card hello1 col-lg-6"  data-aos='fade-left' style={{overflowX:"hidden"}}   data-aos-duration='1500'>
                            <div class="card-body mt-5 mb-5 text-center" style={{overflowX:"hidden"}}  data-aos='fade-left'  data-aos-duration='1000'>
