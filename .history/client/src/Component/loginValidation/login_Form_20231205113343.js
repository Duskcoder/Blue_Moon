...
const SignIn = () => {
    ...
    return (
        <Container className="gee shadow-lg p-3 mb-5 bg-body rounded py-4 mt-5" component="main" maxWidth="xs">
            <Box className="guer mx-auto">
                <img className='img-responsive' src={require('../../images/bluemoon7.jpg')} alt='' width='40%' />
            </Box>
            <Box
                sx={{
                    display: 'flex',
