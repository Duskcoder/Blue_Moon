...
function Footer() {
  return (
    <div className=" text-white">
      ...
      <div className="container m-l-25px text-whites ">
        <div className="mt-4">
          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
              ...
              <ul className="list-unstyled mb-0">
                ...
                <li className="mt-3">
                  <a href="#!" className="text-whites text-decoration-none footer-textsize-follow">
                    Follow Us
                  </a>
                </li>
                <li className="mt-4">
                  <a href="#!" className="text-whites m-l-10px footer-textsize">
