  ...
  return (
    <div className=" text-white">
      <div className="  d-flex   m-auto" id="footer-bg-img">
        <div className="container col-5 m-l-25px text-whites ">
          <div className="mt-4">
          ...
          <section className="text-white mt-4">
            <div className="row">
              ...
              <div className="col-lg-3 col-5 col-md-6 mb-4 mb-md-0">
        ...
        <div className="m-auto col-6 align-content-center float-start">
          <button className="">
