    ...
    <>
      ...
      <form>
              ...
              <div className="head  ">
                <div className="room col-6 col-lg-12 htagsMob mx-5">
                  ...
                  <p className="ptag text-white">
                    ...
                    here.
                    <br /> You can get both, an incredible and relaxing
                    experience while you are on a holiday
                  </p>
                </div>
        ...
        <div className="popup-content" onClick={(e) => e.stopPropagation()}>
          ...
          <button onClick={() => handleButtonClick(' https://wa.me/message/JYC7L3YOFWSUN1')} className="align-items">jhjjj</button>
        </div>
      )}
                  </div>
                </div>
