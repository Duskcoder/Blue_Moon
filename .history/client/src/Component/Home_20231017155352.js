    ...
    <div>
      ...
      <div class="row justify-content-evenly mb-5  mt-5">
        <div class="col-3  text-center  pt-5 ">
          <div className="home-room-button  float-end">
            <div className="home-room-button ">
              <h4>Rooms</h4>
            </div>
            <br />
            <div className="mt-4 border-danger shadow-lg">
              <br />
              <button className="mt-4 btn btn-white btn-animate">View ALL</button>
            </div>
          </div>
        </div>
