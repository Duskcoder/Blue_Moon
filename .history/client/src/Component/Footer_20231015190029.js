          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
              ...
              <ul className="list-unstyled mb-0">
                <li className="mb-3">
                  <a href="#!" className="text-whitestext-whites text-decoration-none footer-textsize">
                ...
                <li className="mt-5">
                  <a href="#!" className="text-whitestext-whitetext-whites text-decoration-none footer-textsize">
                    Follow Us
                  </a>
                </li>
                <li className="mt-4">
